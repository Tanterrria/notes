...
## 3. Коллаборативная фильтрация <a id="id3"></a>

![1](https://github.com/Tanterrria/notes/assets/97233070/0b8f9f06-149f-4a59-8619-843b50c01691 "Катя + Петя -> Кате стоит рекомендовать 3, Пете не стоит рекомендовать 10")
